...
/**
 * Use case for retrieving a page of locations.
 */
interface GetLocationsUseCase {
     ...
     * [Page] of [Location] objects or [Lce.Error] if the network request fails.
     */
    operator fun invoke(page: Int): Flow<Lce<Page<Location>>>
}
